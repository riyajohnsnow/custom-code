...
printf( __( 'A subscription belonging to %1$s has expired. Their subscription\'s details are as follows:', HF_Subscriptions::TEXT_DOMAIN ), $subscription->get_formatted_billing_full_name() );
...
if ( ! empty( $end_time ) ) {
	echo sprintf( __( 'End Date: %s', HF_Subscriptions::TEXT_DOMAIN ), date_i18n( wc_date_format(), $end_time ) ) . "\n";
}
