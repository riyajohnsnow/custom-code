...
<p>
    <?php
    printf(esc_html__('A subscription belonging to %1$s has been cancelled. Their subscription\'s details are as follows:', HF_Subscriptions::TEXT_DOMAIN), esc_html($subscription->get_formatted_billing_full_name()));
    ?>
</p>
...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
    <thead>
        <tr>
            ...
            <th class="td" scope="col" style="text-align:left;"><?php echo esc_html_x('End of Prepaid Term', 'table headings in notification email', HF_Subscriptions::TEXT_DOMAIN); ?></th>
        </tr>
    </thead>
    <tbody>
        <tr>
